...
public class BussinessFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.fragment_bussiness,null);

        recyclerViewBussiness = v.findViewById(R.id.bussiness_recyclerview);
        modelClassArrayList = new ArrayList<>();
        recyclerViewBussiness.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getContext(),modelClassArrayList);
        recyclerViewBussiness.setAdapter(adapter);
