...
public class ScienceFragment extends Fragment {
    ...
    private RecyclerView recyclerViewSciene;
    Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerViewSciene = v.findViewById(R.id.science_recyclerview);
        modelClassArrayList = new ArrayList<>();
        recyclerViewSciene.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getContext(),modelClassArrayList);
        recyclerViewSciene.setAdapter(adapter);
